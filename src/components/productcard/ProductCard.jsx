    ...
    <div className={`bg-cream h-[300px] flex flex-col justify-center p-9 mx-auto rounded-t-3xl w-[255px] `}>
        <button onClick={toggleFav}>
          <div className=' relative bottom-16 left-40 '>
            {!isOpenFav && <img src={Favbtn} alt="" width={37.5} height={35} />}
            {isOpenFav && <img src={FavRedbtn} width={37.5} height={35}/>}
          </div>
        </button>
      ...
      <div className={`bg-white h-[130px] mx-auto rounded-b-3xl w-[255px]`}>
          ...
          <div className=' font-itim text-base pb-8 pl-6'>Price: <span className=' text-red'>{price}</span></div>
      </div>
   </div> 
  )
}
